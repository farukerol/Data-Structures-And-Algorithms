...
public class Account {
     ...
     */
    private LinkedList<Account> blockList = new LinkedList<Account>();
    /**
     * Keeps who blocked the user
     */
    private LinkedList<Account> whoBlockList = new LinkedList<Account>();
    /**
     ...
     */
    public void setInBox(LinkedList<Message> inBox) {
        this.inBox = inBox;
    }
    /**
     ...
     */
    public void setOutBox(LinkedList<Message> outBox) {
        this.outBox = outBox;
    }
    /**
     ...
     */
    public LinkedList<Account> getBlockList() {
        return blockList;
    }
    /**
     * Set the account's Blocklist.
     */
    public void setBlockList(LinkedList<Account> blockList) {
        this.blockList = blockList;
    }
    /**
     * Get the account's who blocked list.
     */
    public LinkedList<Account> getWhoBlockList() {
        return whoBlockList;
    }
    /**
     * Set the account's who blocked list.
     */
    public void setWhoBlockList(LinkedList<Account> whoBlockList) {
